  ...
  return (
    <section className="w-full flex justify-center py-20 font-clash">
      <div className="max-w-7xl w-full px-6">
        <div
          className="rounded-3xl p-10 bg-gradient-to-b from-[#EAEAEA] to-[#008080]/40 shadow-md"
        >
          {/* Header */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
            <div>
              <h2 className="text-[50px] font-medium leading-snug text-black">
                <span className="text-[#008080]">100+ Proyek</span> Sukses{" "}
                <br />
                Dikerjakan
              </h2>
            </div>
            <p className="text-[20px] text-black leading-tight font-normal mt-4">
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-black text-center">
            <div className="py-6 px-4">
              <h3 className="text-[7rem] font-normal text-[#008080]">60+</h3>
              <p className="mt-3 text-[38px] font-normal leading-none text-black">
                Klien di tahun <br /> 2018-2019
              </p>
            </div>
            <div className="py-6 px-4">
              <h3 className="text-[7rem] font-normal text-[#008080]">50+</h3>
              <p className="mt-3 text-[38px] font-normal leading-none text-black">
