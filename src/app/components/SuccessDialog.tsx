...
import emailsukses from "/public/icons/emailsukses.png";
      ...
      {open && !isMobile && (
        <Dialog open={open} onOpenChange={onClose}>
            <DialogTitle className="hidden">
              Sukses : Email telah berhasil dikirim
            </DialogTitle>
            <DialogContent className="p-8 border-0 font-clash shadow-none max-w-[30%] min-h-[50%]">
              ...
              >
                <h1 className="text-3xl font-medium">Pesan Anda Terkirim!</h1>
                <motion.div
                  initial={{ scale: 0.5, opacity: 0 }}
                  animate={{ scale: 1, opacity: 1 }}
                  exit={{ scale: 0, opacity: 0 }}
                ...
                <p className="font-normal text-xl w-[70%]">
                  Pesan anda sudah terkirim, pantau email anda untuk feedback
                  dari kami.
                </p>
              </motion.div>
            </DialogContent>
