...
export default function NavBar() {
  ...
  return (
    <div className="flex justify-center items-center w-full">
      <div className="fixed top-5 z-60 flex items-center justify-between py-4 rounded-2xl gap-26 shadow-2xl px-6 font-instrument text-[24px] text-black/70 bg-[#FAFAFA]">
        {/* Logo */}
